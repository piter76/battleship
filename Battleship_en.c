/*settings*{"name":"Battleship","author":"Piter76","image":[255,255,255,255,255,251,251,255,255,255,255,255,255,31,255,255,255,251,177,255,255,241,241,255,241,241,255,255,255,187,17,255,255,255,31,255,255,255,255,255,251,27,17,255,255,255,255,255,255,255,255,255,177,27,17,31,255,255,255,255,255,255,255,251,17,27,17,191,255,255,255,255,255,255,255,241,17,27,27,255,255,255,255,255,255,255,255,255,17,27,191,255,255,255,255,255,255,255,255,255,17,27,255,255,255,255,255,255,255,255,255,255,241,187,255,255,255,255,255,255,36,68,238,238,235,235,238,238,238,228,68,78,34,36,68,78,238,235,238,238,228,71,34,78,226,34,37,36,68,68,68,68,68,114,114,78,238,34,85,82,34,34,34,34,34,39,34,238,238,226,34,34,34,34,34,34,34,34,46,238,238,238,34,34,34,34,34,34,34,34,238,238]}*/
...
void ship_mod(int ship_size, int sw) {
	...
	if(sw == 1) {
		...
		drawstring("You hit   - masted", 7, 112);
		drawNum(ship_size, 57, 112, 5);
	}
}
...
void menu(){
	...
	setcolor(1);
	drawstring("A PLAY", 10, 112);
	drawstring("B SET SHIPS", 55, 112);
	setcolor(10);
	...
	if(getkey() == KEY_A){
		...
		setcolor(5);
		drawstring("SHOOT!!", 40, 112);
	}
	else if(getkey() == KEY_B){
		draw_box(0, 104, 127, 127, 4);
		setcolor(7);
		drawstring("Place ships", 30, 112);
	...
	while(1){
			...
			switch (game()){
				...
				case 1:
					...
					setcolor(1);
					drawstring("Redy. Press  B", 16, 112);
					while(getkey() != KEY_B){
						clear_battlefield();
						redraw_ships();
						//redraw_shoots();
